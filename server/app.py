...
"""
FastAPI application for the Support Ticket Router Environment.

This module creates an HTTP server that exposes the SupportTicketRouterEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m support_ticket_router.server.app
    ...
    multiple workers:
        uvicorn support_ticket_router.server.app:app --workers 4
    """
    import uvicorn
